    ...
    <div className="space-y-4">
      ...
      <div className="space-y-1">
        ...
        <Select value={defaultLocale} onValueChange={onDefaultLocaleChange}>
          <SelectTrigger id="forms-studio-form-default-locale" className="h-8">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
            {localeList.map((locale) => (
      ...
      <div className="space-y-1">
        ...
        >
          <SelectTrigger id="forms-studio-form-default-role" className="h-8">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
      ...
      <div className="space-y-1">
        ...
        >
          <SelectTrigger id="forms-studio-form-density" className="h-8">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
      ...
      <div className="space-y-1">
        ...
        >
          <SelectTrigger id="forms-studio-form-label-position" className="h-8">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
      ...
      <div className="space-y-1">
        ...
        >
          <SelectTrigger id="forms-studio-form-page-mode" className="h-8">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
      ...
      <div className="space-y-1">
        <YesNoRow
          label={t('forms.studio.parameters.progress.label')}
          value={progressEnabled && showProgress}
