...
const events = [
  ...
  { id: 'financial_pl.ksef_submission.repoll_requested', label: 'KSeF Submission Re-poll', entity: 'ksef_submission', category: 'lifecycle' },
  { id: 'financial_pl.ksef_submission.offline_send_requested', label: 'KSeF Offline Submission Send', entity: 'ksef_submission', category: 'lifecycle' },
