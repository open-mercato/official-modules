 ...
 */
@Entity({ tableName: 'pdf_generators_generated_documents' })
@Index({ name: 'pdf_generators_generated_documents_org_idx', properties: ['organizationId'] })
@Index({ name: 'pdf_generators_generated_documents_resource_idx', properties: ['organizationId', 'resourceKind', 'resourceId'] })
