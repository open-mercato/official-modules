...
/**
 * Body accepted by POST /api/pdf-generators/generate.
 *
...
/**
 * Body accepted by POST /api/pdf-generators/preview.
 *
...
/** Query params for GET /api/pdf-generators/documents (generation history). */
