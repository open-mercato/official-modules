...
| [SPEC-005](SPEC-005-2026-06-26-financial-pl-ksef-connector.md) | 2026-06-26 | financial_pl — Polish KSeF 2.0 connector | Send-only KSeF e-invoicing (FA(3), token auth, status/UPO, idempotency + reconciliation sweep), per-org credentials, UMES injection on sales invoices |
